...
wb=load_workbook(filename="new_xlsx.xlsx",data_only=True)
ws=wb['E0.30']
...
document.add_paragraph("P(ZUCS/R0*Ia*Ip): "+str(ws['b8'].value),style='Normal')
